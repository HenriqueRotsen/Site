...
const NAV_ITEMS = [
  ...
  { key: 'contracts', label: 'Contratos', icon: icons.contracts },
  { key: 'contract-templates', label: 'Modelos', icon: icons.templates },
...
export function StatusBadge({ status }) {
  ...
  const tone = status === 'enviado' ? 'enviada' : status === 'retificado' ? 'atrasada' : status;
  return (
