  ...
  return (
    <div className='curriculo-page'>
      <div className="curriculo-watermarks" aria-hidden="true">
        <img src={LogoHr} alt="" className="curriculo-watermark curriculo-watermark--1" />
        <img src={LogoHr} alt="" className="curriculo-watermark curriculo-watermark--2" />
        <img src={LogoHr} alt="" className="curriculo-watermark curriculo-watermark--3" />
      </div>
